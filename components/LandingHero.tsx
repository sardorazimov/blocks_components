        ...
        <div className="flex flex-wrap -m-4 hover ">
          <div className="xl:w-1/3 md:w-1/2 p-4 ">
            <div className="border p-6 rounded-lg  cursor-pointer dark:bg-neutral-600 bg-white text-gray-900 shadow-lg hover:bg-neutral-300">
              ...
              <h2 className="text-lg text-neutral-800 font-medium title-font mb-2 dark:text-neutral-200">
                Shooting Stars
              </h2>
              <p className="leading-relaxed text-base text-gray-900 dark:text-neutral-300">
