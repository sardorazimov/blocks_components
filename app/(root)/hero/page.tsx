    ...
    <div >
       <div className='flex   w-full h-12 my-2 justify-between '>
           <div className='grid grid-cols-4 gap-4'>
            <Heart className='text-rose-900 cursor-pointer rounded' />
      ...
      <div className='  w-full h-screen'>
        <div className="max-w-xl mx-auto text-center xl:max-w-2xl py-4">
          <div className="text-3xl font-bold leading-tight
             sm:text-4xl xl:text-5xl mb-6">
              Hero page
            </div>
          <p className="mb-4 text-xl ">We are creating a tool that helps you be more productive and efficient when building
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-10 md:px-20">
          <div className="transition hover:transition-opacity  rounded-xl shadow-lg overflow-hidden border border-purple-800 hover:shadow-purple-900 hover:border-purple-950 ">
            <div className="relative">
              <img className="w-full h-48 object-contain" src="/img/2.png" />
              <div className="absolute top-0 right-0 bg-indigo-500  font-bold px-2 py-1 m-2 rounded-md">New
              </div>
              <div className="absolute bottom-0 right-0   px-2 py-1 m-2 rounded-md text-xs">3 min read
              </div>
            </div>
            <div className="p-4">
              <div className="text-lg font-medium  mb-2">Title</div>
              <p className="text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed auctor, mi sed
          ...
          <div className="transition hover:transition-opacity  rounded-xl shadow-lg overflow-hidden border border-purple-800 hover:shadow-purple-900 hover:border-purple-950">
            <div className="relative">
              ...
              <div className="absolute top-0 right-0 bg-indigo-500  font-bold px-2 py-1 m-2 rounded-md">New</div>
              <div className="absolute bottom-0 right-0   px-2 py-1 m-2 rounded-md text-xs">3 min read
              </div>
            </div>
            <div className="p-4">
